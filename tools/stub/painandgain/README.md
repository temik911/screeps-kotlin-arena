...
Maps `map-match1..25.txt` and `map-match28..30.txt` are the `DEBUG_MAP` dumps of the live matches, numbered by match — the gaps are matches whose map was one already here (`#` wall, `~` swamp, `m`/`e` the two armies'
