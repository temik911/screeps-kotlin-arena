// generated from the client typings game/constants.d.ts
export const OK = 0;
...
export const CONSTRUCTION_COST = { StructureTower: 1250, StructureExtension: 200, StructureRoad: 10, StructureContainer: 100, StructureWall: 100, StructureRampart: 200, StructureSpawn: 3000 };
