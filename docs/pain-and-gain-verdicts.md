...
## Строки, снятые при удалении кода (база pain-and-gain-v247)
...
прибор: тиков, в которые ряд целился на клетку ближе (v196)
```

## Строки, снятые при удалении кода (база 75ae7e1)
