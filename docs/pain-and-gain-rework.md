...
`Formation.kt` тождественно (абзац v248); срез 2 — v249, одно правило назначения крип → место: живьём не хуже на
MetalicaX#15 и лучше на Coldkimchi#1, гейт закрывала строка scatter из-за качания постуры (абзац v249); остаток этапа 6,
срез 1 — v250, срок постуры от кандидата: гейт 135/135, A/B не хуже v249 на обоих ботах, батч v248–v250 посажен (абзац
v250); этап 9 — v251 тактик в Tactician.kt (тождество), v252 шаг как Proposal с приоритетом и прибором tac (тождество),
v253 спасение первым в очереди арбитра отвергнуто живым A/B (Coldkimchi#1 1-7 против 3-5), v254 = v252 (абзац
v251–v254); этап 10 — v255–v263: функции, сегменты runArmy и tickBody, константы, состояние и типы по файлам стадий
(тождество), мёртвое снято (тождество), перебор замыслов командира под бюджетом тика; PainAndGain.kt 7 044 → 663 строки;
раздел «Архитектура» в docs/pain-and-gain.md (абзац v255–v263); серия 20 рейтинговых на v263: 9-11, 1286→1248 —
жеребьёвка (без двух новых ботов 9-6, как v245), признаков изменения поведения переработкой нет (абзац «v263 — серия из
20»).
