...
стадиям перенесены на этапы 6 и 9); этап 5 — v240, 13.09.2026 (абзац v240, живой A/B); этап 6, срез 1 — v241, 13.09.2026 (абзац v241, тождество); срез 2 — v242 отвергнут живым A/B, посажена v243 без
него (абзац v242); остаток этапа 6 (постановка как решатель) переносится за этапы 7–9; этап 7 — уборка мёртвого кода
посажена, v244 (threatAt + назначение огня/лечения) отвергнута живым A/B 0-8/0-8, посажена v245 без неё (абзац v244).
