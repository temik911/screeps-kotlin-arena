...
internal fun PainAndGain.captureBlock(ctx: Ctx, f: FlagInfo): String? {
    ...
    // ⚠️ ОТВЕРГНУТО ЗАМЕРОМ (v329): «против того, кто не бьёт наших в группе, паритет не сторож» (v328). Ворота и правда
    // отказывали по паритету 1 382 раза за матч, но снятие их не вернуло темп: наших флагов 1,34 против 1,89 у v326, тел
    // на флагах 1,00 против 1,51 — взятые сверх меры флаги вешают дебафф на нас же и ускоряют потерю следующих
