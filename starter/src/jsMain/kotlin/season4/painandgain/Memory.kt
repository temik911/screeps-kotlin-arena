...
internal object Memory {
    ...
    /** Тиков подряд, что его стволы расколоты (`splitNow`, v664, см. USE_SPLIT_HELD). */
    ...
    /** Последний флаг, к которому безоружный бегун шёл (v686, см. USE_SCOUT_FLEE_KEEPS_AIM): бегун -> флаг. */
    val scoutAim = HashMap<String, String>()
