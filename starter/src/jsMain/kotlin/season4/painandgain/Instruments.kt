...
internal val T_LINE = listOf(
    ...
    "runner", "mrun", "hw", "hwwhy", "hor", "fuse", "rnear", "repass", "heord", "ward", "fanroom", "shield", "dbfveto", "froom", "farmoff", "unwipe", "hkeep", "wipe", "engage", "mguard", "kthreat", "party", "fist2", "cap3", "cap3why", "capfree", "engbar", "kaway", "engidle", "kback", "pusheng", "engmarch", "fgrp", "column", "defend", "tour", "refuge", "rfcells", "hfront", "nofront", "hstep", "cmdwhy", "ovl", "conc", "concall", "concmax", "concfan", "ehshot", "rfoc", "ehrch", "shotnet", "okill", "okkill", "lostrace", "gather", "close3", "guard", "gstrip", "warm",
...
internal const val BOT_VERSION = "v575"
