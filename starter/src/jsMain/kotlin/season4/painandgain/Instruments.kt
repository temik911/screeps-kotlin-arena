...
/** Добивание по доле хитов (v279, frf=сменено/приказов:на раненого до/после): приказов огня за матч, сколько из них
 *  правило «наименьшая доля в досягаемости» перевело на другую цель, и сколько приказов легло на раненого врага по
 *  прежнему ранжиру и по новому. */
internal var frfOrders = 0
internal var frfChanged = 0
internal var frfWoundOld = 0
internal var frfWoundNew = 0
...
internal const val BOT_VERSION = "v279"
