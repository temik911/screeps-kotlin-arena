...
/** Одна целевая группа (v272, tgrp=притяжение от группы/две ловимые группы в контакте/тиков с 2+ группами/смен цели). */
internal var tgrpTicks = 0
internal var tgrpSplit = 0
internal var tgrpOn = 0
internal var tgrpSwitch = 0
/** Прижим (v273, prs=тиков с затравками у цели/из них с открытой стороной/средний наименьший ход отхода цели/тиков, когда цель
 *  снята застоем/тиков без перевеса над целью — прижима нет). */
internal var prsTicks = 0
internal var prsSided = 0
internal var prsRoom = 0
internal var prsStall = 0
internal var prsWeak = 0
...
internal const val BOT_VERSION = "v273"
