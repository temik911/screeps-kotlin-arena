...
/** На сколько тиков вперёд смотрит БЕЗОРУЖНЫЙ гарнизонный крип, решая сойти с флага (v359, см. garrisonStays): у него
 *  100 хитов при 185–192 уроне его мили вплотную и 66 с трёх клеток, поэтому «урон превысил лечение» и «он уже мёртв»
 *  для скаута один и тот же тик. Трое из 12 погибших против けろびー#19 — скауты с агонией 1–2 тика, и метка бегства
 *  дважды сработала ровно в тик смерти, хотя его вооружённый стоял в шести клетках 4–5 тиков. */
internal const val SCOUT_LEAD = 2
