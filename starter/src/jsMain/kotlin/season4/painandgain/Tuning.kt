...
/** ⚠️ СЖАТ ДО ТРЁХ (v392): дальность выстрела равна трём, поэтому кулак радиуса ЧЕТЫРЕ перекрытия не даёт — два
 *  стрелка на его краях стоят в восьми клетках друг от друга и общей цели не имеют. Прибор `ovl=` (v391) намерил это
 *  живьём против `MetalicaX#9`: наши стрелки достают лучшую его цель в среднем 0,37 ствола, трое и больше — в 5,5 %
 *  тиков, а легло ровно 1,00 выстрела на цель, то есть стреляем всегда поодиночке. Радиус три — тот, при котором два
 *  крайних стрелка ещё имеют общую клетку в досягаемости. */
internal const val FIST_RADIUS = 3
