...
internal const val GROUP_WINDOW = 100
internal const val GROUP_SAFE_DMG = 300

/** ДАВЛЕНИЕ НА ФЛАГ (v307): столько его боевых крипов в стольких клетках от флага столько тиков подряд — и хранитель
 *  уходит; меньше — стоит, чем бы его ни пугали. Контрфакт разбора 21 поражения от けろびー (Opus, по реплеям): если
 *  терять флаг только при двоих в трёх клетках пять тиков, счёт к 2000-му тику 27,1 тыс. : 21,5 тыс. и 16 побед из 21;
 *  при троих — 36,6 тыс. : 11,9 тыс. и 21 из 21; при «двое хоть на тик» — 17,0 тыс. : 31,6 тыс. и 2 из 21. Сравнение
 *  сил (v305) сгоняло нашего мили с флага одним его стрелком: 34–43 снятия за матч. */
internal const val PRESS_COUNT = 2
internal const val PRESS_CELLS = 3
internal const val PRESS_TICKS = 5
