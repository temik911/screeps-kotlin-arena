...
/** Вето захвата по контакту действует только когда в этом контакте ИДЁТ размен (v431, см. captureBlock). Прибор
 *  warmcap, заведённый в v221 ровно для этого вопроса, даёт ответ: против Coldkimchi#1 1 096 отказов из 4 636 (24 %)
 *  выданы в контакте, где ни одна сторона не теряла STALL_DAMAGE. Дебафф флага платится боем; пока хиты не тают,
 *  он не стоит ничего, а очки идут. */
internal const val USE_CAP_ONLY_WHEN_TRADING = true
