...
/** Мгновенная сходимость выше яруса «стрелки первыми» в выборе фокуса (v423, см. focusCmp): оба яруса существуют с
 *  v60 и v70, менялся только порядок. Чистая пара 16 игр против MetalicaX#13: выстрелов в одну цель за тик у нас
 *  2,8 +- 0,4 в победах против 2,2 +- 0,5 в поражениях при ПОСТОЯННОЙ его сосредоточенности (2,2 и 2,6); разрез по
 *  разности «наш conc минус его» >= +0,30 даёт 5 побед из 6 против 1 из 9. */
internal const val USE_FOCUS_GUNS_FIRST = true
