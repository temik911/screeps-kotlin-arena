...
/** Внутри роли фокус выше ставит цель, до которой дотянулся наш мили (v429, см. focusCmp): его лечение на цель
 *  129-147 в тик, залп трёх стрелков 180 даёт чистыми 33-51, а с ударом мили 420 — уже 273-291, вшестеро быстрее.
 *  Ярус стоит ПОД ролью, поэтому выбирается не «кто вместо стрелка», а «какой из стрелков». */
internal const val USE_FOCUS_MELEE_REACH = true
