...
object PainAndGain {
    ...
    internal var firstDeathTick = 0                        // тик первой смерти боевого крипа любой стороны (v287)
    internal var combatPeakOurs = 0                        // наибольшее число наших боевых по телу (v287)
    internal var combatPeakHis = 0                         // и его (v287)
    internal var openingNow = false                        // дебют контакта: размен начался, смертей нет (v287, см. Fight)
