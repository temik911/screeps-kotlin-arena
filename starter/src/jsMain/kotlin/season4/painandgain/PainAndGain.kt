...
object PainAndGain {
    ...
    /** Командир правит боем и во время наступления (v217, см. выбор cmdMode). */
    private const val USE_COMMAND_FIGHT_WHILE_PUSHING = true
...
cpuMark("a.evade")
        ...
        cmdMode = when {
            ...
            (USE_COMMAND_FIGHT_WHILE_PUSHING || !pushing) && underTheirFire && (enemyMassedNow || foesAtHand >= COMMAND_MIN_FOES) &&
