...
internal fun PainAndGain.creepTurn(creep: Creep, ctx: Ctx, t: ArmyTick) {
    with(t) {
        ...
        val holdMelee =  (!openingNow && isMelee(creep) && !hasRanged(creep) && posture == Posture.ANNIHILATE && !pushing && contact && pressTarget == null &&
